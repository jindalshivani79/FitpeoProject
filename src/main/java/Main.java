...
public class Main {
	...
	public static void main(String[] args) throws Exception{
        ...
        driver.findElement(By.xpath("//a[@href='/revenue-calculator']")).click();  // Navigate to the Revenue Calculator using Xpath locator
      
        // Wait until the slider is visible
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement elementSliderInput = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@type='range']")));
        ...
        actions.moveToElement(textField).click().keyDown(Keys.CONTROL).sendKeys("a").keyUp(Keys.CONTROL).sendKeys(Keys.BACK_SPACE).perform();
